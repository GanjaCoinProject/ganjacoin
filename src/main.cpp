...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Ganjacoin, the cryptocurrency for the marijuana biz in Europe";
        CTransaction txNew;
        txNew.nTime = 1413373072;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xaa32eb974fd7f5f51c891f6c5f98d5f38bb5a532a095544ed54a64f5cecf847d"));
        block.print();
